       ...
       <div id=firtSection>
                ...
                <div class="d-flex justify-content-between col-12">
                    ...
                    <div class="container mt-2">
                        <div class="row ">
                            ...
                            <ul class="QuickLinks_ul__WOQOA d-flex justify-content-center grid gap column-gap-3" data-test="quicklinks" style="background-color: transparent">
        ...
        <div class="container">
            <div class="row d-flex flex-row  justify-content-between">
                ...
                <div class="swiper w-50  h-75 border border-danger border-5">
                    ...
                    <script>
                        ...
                        function insert() {
                            immagini.forEach(element => {
                                ...
                                ancor.classList.add('album-item', "d-flex", "flex-column", "col-12", "col-md-2",  "w-75", "bg-warning" );
