<x-main>
    ...
    <div class="container">
        <div id="carouselExampleIndicators"
            class="carousel carousel-dark slide border border-2 rounded border-warning carousel ">
    ...
    {{--    -------OFFERTE --}}
    <div id="offerteHome" class="rounded ">
        ...
        <h2 class="text-danger text-center fw-bold fs-1">Nuovi Prodotti</h2>
        <div class=" d-flex  flex-wrap justify-content-between flex-row border border-3 border-danger rounded m-5 p-3 ">
